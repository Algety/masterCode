...
* Images load as expected on the main page and within modals.
* Buttons function properly, leading users to their intended actions.
* The secret code is generated and displayed as intended.
* Colour selection via the answer box works reliably across devices.
* The modals are displayed correctly.

During the testing process at various stages of development, several bugs were identified and resolved, such as incorrect checking of player answers, displaying the wrong number of pins in the clue box.

### User testing
Four players tested the game. 
